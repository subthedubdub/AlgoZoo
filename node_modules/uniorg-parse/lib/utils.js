...
exports.escapeRegExp = exports.unescapeCodeInString = exports.greaterElements = exports.restrictionFor = exports.OrgRegexUtils = void 0;
class OrgRegexUtils {
    constructor(options) {
    ...
    // Emacs's doesn't.
    subsuperscriptRe() {
        return new RegExp(`(\\S)([_^])((?:${multibraceRe('\\{', '\\}', this.options.matchSexpDepth, 'inBraces')})|(?:${multibraceRe('\\(', '\\)', this.options.matchSexpDepth, 'inBrackets')})|(?:\\*|[+-]?[\\p{L}\\d.,\\\\]*(?:\\p{L}|\\d)))`, 'u');
        /**
         ...
         */
        function multibraceRe(left, right, n, name = '') {
...
exports.OrgRegexUtils = OrgRegexUtils;
